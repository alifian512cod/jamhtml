...
<title>Putra Irvan - Jam</title>
<link rel="shortcut icon" href="./icon/iconlogo.ico" type="image/ico" />
...
var servertimestring=(servermode=="server-php")? '<? print date("F d, Y H:i:s", time())?>' : (servermode=="server-ssi")? '<!--#config timefmt="%B %d, %Y %H:%M:%S"--><!--#echo var="DATE_LOCAL" -->' : '9/11/2022 9:10:36 AM'
...
"<div class='FontHari'>"+mingguWIB+", "+tanggal+" "+bulanWIB+" 2022 </div><div class='FontDigit'>"+formatField(hour)+":"+formatField(minutes)+":"+formatField(seconds)+" WIB</div></a>"+
"<hr color='#333333'>"+
...
"<hr color='#333333'>"+
"<div class='FontHariU'>"+weekUTC+", "+monthUTC+" "+tanggalUTC+", 2022 </div><div class='FontDigitU'>"+formatField(hourUTC)+":"+formatField(minutes)+":"+formatField(seconds)+" UTC</div>"
}
...
<body bgcolor="#222222" topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0">
<center>
